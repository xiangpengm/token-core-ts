...
export class NftUnlockContractCheck100 extends SmartContract {
    static readonly MAX_OUTPUT = 100
    ...
    public unlock(
        ...
        assert(nOutputs <= NftUnlockContractCheck100.MAX_OUTPUT)
        for (let i = 0; i < NftUnlockContractCheck100.MAX_OUTPUT; i++) {
