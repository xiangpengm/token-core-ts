...
export class NftUnlockContractCheck10 extends SmartContract {
    static readonly MAX_OUTPUT = 10
    ...
    public unlock(
        ...
        assert(nOutputs <= NftUnlockContractCheck10.MAX_OUTPUT)
        for (let i = 0; i < NftUnlockContractCheck10.MAX_OUTPUT; i++) {
