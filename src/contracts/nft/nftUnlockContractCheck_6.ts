...
export class NftUnlockContractCheck6 extends SmartContract {
    static readonly MAX_OUTPUT = 6
    ...
    public unlock(
        ...
        assert(nOutputs <= NftUnlockContractCheck6.MAX_OUTPUT)
        for (let i = 0; i < NftUnlockContractCheck6.MAX_OUTPUT; i++) {
