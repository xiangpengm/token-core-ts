...
export class NftUnlockContractCheck extends SmartContract {
    static readonly MAX_OUTPUT = 3
    ...
    public unlock(
        ...
        assert(nOutputs <= NftUnlockContractCheck.MAX_OUTPUT)
        for (let i = 0; i < NftUnlockContractCheck.MAX_OUTPUT; i++) {
